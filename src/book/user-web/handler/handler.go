...
func Init() {
	serviceClient = us.NewUserService("demo.micro.book.srv.user", client.DefaultClient)

	authClient = auth.NewService("demo.micro.book.srv.auth", client.DefaultClient)
}
